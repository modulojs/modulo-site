...
contentlist: {"Type":"contentlist","Parent":"modulo","DefName":null,"DefFinalizers":["Load","command|Command"],"build":"build","Name":"contentlist","DefinitionName":"contentlist","data":[["index.html"," Modulo"," ᵐ°dᵘ⁄o"],["docs.html"," Docs"],["tutorial.html"," Tutorial"],["playground.html"," Playground"],["article-index.html"," News"],["about.html"," About"]],"commands":["buildall"]},

articlelist: {"Type":"contentlist","Parent":"modulo","DefName":null,"DefFinalizers":["Load","command|Command"],"build":"build","Name":"articlelist","DefinitionName":"articlelist","data":[["article-example-1.html"],["article-example-2.html"]],"files":[{"body":"\n# Article Example\n\n---\n\n[Edit me!](?argv=edit)\n\n**How to edit:** Edit Markdown by opening up `article-example.html` in a text\neditor. Note that after `build`, this source file is replaced by pure HTML.\n\n**GUI editing:** If you use a graphical Markdown editor, be sure to configure\nthe starting \"meta\" format as the entire first line of this file (i.e.\nincluding the \"script\" tags AND the \"---\").\n\n**Limitations:** The Modulo framework's built-in Markdown parser is geared\ntoward quick docs. If you need more features (e.g. lists), it's recommended to\nswap in a new library.\n\n\n","page_title":"My Cool Article","page_author":"Authorino, PhD in Authoring","desc":"\n     An example page using HTML-Markdown, a hybrid format that can be\n     interpreted as HTML or Markdown.","Source":"article-example-1.html"},{"body":"\n# Code Example\n\n### Syntax Highlighting\n\n```html\n<h1>HTML snippet</h1>\n```\n\n```js\nconst jsSnippet = async function demo () { }\n```\n\n### Live Editors\n\n#### HTML\n\n```html=embed\n<h1>HTML demo</h1>\n```\n\n#### Modulo Web Component\n\n```html=embed\n<script Modulo src=static/Modulo.html>\n<Component name=Demo>\n  <Props say></Props>\n  <Template>\n    <h1>{{ props.say }}</h1>\n  </Template>\n</Component>\n<-script>\n<x-Demo say=\"Component demo\"></x-Demo>\n```\n\n#### Markdown Page\n\n```html=embed\n<script src=static/Modulo.html><-script><script type=f>---\npage_title: Example Title\n---\nMarkdown Page Demo\n```\n","page_title":"Article II: The Second Article","page_author":"Authorino, PhD in Authoring","desc":"\n     A more advanced example page. This time, we employ use of live snippets.","Source":"article-example-2.html"}],"commands":["buildall"]},

navlinks: {"Type":"contentlist","Parent":"modulo","DefName":null,"DefFinalizers":["Load","command|Command"],"build":"build","Name":"navlinks","DefinitionName":"navlinks","data":[["https://codeberg.org/modulo/modulo/","Source (Git at Codeberg)"]],"commands":[" "]},
...
x: {"Type":"library","Parent":"modulo","DefName":null,"Contains":"core","DefLoaders":["DefTarget","DefinedAs","Src","Content"],"namespace":"x","Name":"x","DefinitionName":"x","Source":"file:///home/michaelb/projects/modulo-site/static/components/","ChildrenNames":["x_WordArt3D","x_AbstractArt3D","x_Demo","x_PageControls","x_Page"]},
