...
var props,component;return{_setLocal:function(o){props=o.props;component=o.component}, "renderCallback":typeof renderCallback !=="undefined"?renderCallback:undefined}}
...
modulo3: {"Type":"modulo","Parent":"modulo","DefName":null,"build":{"mainModules":["configuration1","configuration","_component_Frame","_component_TextEdit","_component_Editor","_component_Page","Page","Search","SyntaxHighlighter","MirrorEditor","TableOfContents","QuickDemo","x_WordArt3D","x_Downloads","x_AbstractArt3D","x_Demo","x_PageControls","x_Page"]},"defaultContent":"<meta charset=utf8><modulo-Page>","fileSelector":"script[type='mdocs'],template[type='mdocs'],style[type='mdocs'],script[type='md'],template[type='md'],script[type='f'],template[type='f'],style[type='f']","scriptSelector":"script[src$='mdu.js'],script[src$='Modulo.js'],script[src='?'],script[src$='Modulo.html']","version":"0.1.0","timeout":5000,"ChildPrefix":"","Contains":"core","DefLoaders":["DefTarget","DefinedAs","Src","Content"],"defaultDef":{"DefTarget":null,"DefinedAs":null,"DefName":null},"defaultDefLoaders":["DefTarget","DefinedAs","DataType","Src"],"defaultDefBuilders":["FilterContent","ContentType","Load"],"namespace":"x","Name":"modulo3","DefinitionName":"modulo3","Source":"file:///home/michaelb/projects/modulo-site/static/index.html","ChildrenNames":["contentlist","buildlist","navlinks","nestedpaths","include3","include4","x","configuration1"]},
...
contentlist: {"Type":"contentlist","Parent":"modulo3","DefName":null,"DefFinalizers":["command|Command"],"build":"build","Name":"contentlist","DefinitionName":"contentlist","data":[["index.html"," Modulo"," ᵐ°dᵘ⁄o"],["docs/index.html"," Docs"],["playground.html"," Playground"],["about.html"," About"]],"commands":[" "]},

buildlist: {"Type":"contentlist","Parent":"modulo3","DefName":null,"DefFinalizers":["command|Command"],"build":"build","Name":"buildlist","DefinitionName":"buildlist","data":[["index.html"],["playground.html"],["about.html"],["404.html"]],"commands":["buildall"]},

navlinks: {"Type":"contentlist","Parent":"modulo3","DefName":null,"DefFinalizers":["command|Command"],"build":"build","Name":"navlinks","DefinitionName":"navlinks","data":[["https://codeberg.org/modulo/modulo/","Source (Git)"],["https://www.npmjs.com/package/create-modulo","create-modulo (npmjs)"]],"commands":[" "]},

nestedpaths: {"Type":"contentlist","Parent":"modulo3","DefName":null,"DefFinalizers":["command|Command"],"build":"build","Name":"nestedpaths","DefinitionName":"nestedpaths","data":[["docs"],["news"]],"commands":[" "]},

include3: {"Type":"include","Parent":"modulo3","Content":"\n    <meta name=\"charset\" charset=\"utf8\">\n    <meta name=\"content-type\" http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\">\n    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n    <meta name=\"robots\" content=\"index, follow\">\n    <meta name=\"revisit-after\" content=\"30 days\">\n    <script src=\"js/main.js.htm\"></script>\n","DefName":null,"ServerTemplate":"{% for p, v in entries %}<script src=\"https://{{ server }}/{{ v }}\"></script>{% endfor %}","DefLoaders":["DefTarget","DefinedAs","Src","Server","LoadMode"],"Name":"include3","DefinitionName":"include3"},

include4: {"Type":"include","Parent":"modulo3","Content":"\n<style>\n    :root {\n        /* Set site-wide CSS variables here */\n        --color: #B90183;\n        --color-alt: #82d4a444;\n        --fg: #000;\n        --fg-shading: #05051020;\n        --bg: #fff;\n        --bg-semi: #ffffff99;\n        --fg-inv: #fff;\n        --fg-inv-shading: #ffffff20;\n        --bg-inv: #000;\n        --bg-inv-semi: #00000099;\n\n        --page-width: 1000px;\n    }\n\n    @media (prefers-color-scheme: dark) {\n        :root {\n            --color: #B90183;\n            --color-alt: #82d4a444;\n            --fg: #eee;\n            --fg-shading: #ffffff33;\n            --bg: #000;\n            --bg-semi: #00000099;\n            --fg-inv: #000;\n            --fg-inv-shading: #00000020;\n            --bg-inv: #fff;\n            --bg-inv-semi: #ffffff99;\n        }\n    }\n\n    /* Configure misc site-wide base settings */\n    body {\n        background: var(--bg);\n        color: var(--fg);\n        margin: 0;\n        line-height: 1.5;\n    }\n\n    /* To get syntax editors looking better on both themes */\n    modulo-Editor {\n        background: WhiteSmoke;\n        display: block;\n    }\n</style>\n","DefName":null,"ServerTemplate":"{% for p, v in entries %}<script src=\"https://{{ server }}/{{ v }}\"></script>{% endfor %}","DefLoaders":["DefTarget","DefinedAs","Src","Server","LoadMode"],"Name":"include4","DefinitionName":"include4"},

x: {"Type":"library","Parent":"modulo3","DefName":null,"Contains":"core","DefLoaders":["DefTarget","DefinedAs","Src","Content"],"namespace":"x","Name":"x","DefinitionName":"x","Source":"file:///home/michaelb/projects/modulo-site/static/components/","ChildrenNames":["x_WordArt3D","x_Downloads","x_AbstractArt3D","x_Demo","x_PageControls","x_Page"]},

configuration1: {"Type":"configuration","Parent":"modulo3","DefName":null,"DefLoaders":["DefTarget","DefinedAs","Src|SrcSync","Content|Code","DefinitionName|MainRequire"],"Name":"configuration1"},
