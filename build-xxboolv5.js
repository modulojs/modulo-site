...
const ctx = { local, global: this.modulo, file: this.modulo.file };
return this.renderFunc(Object.assign(ctx, local), this);
}
} 
...
escaperoute: s => escapere(s).replace(/:([a-z]+)/gi, '(?<$1>[^/]+)'),
...
MDOCS: s => modulo.contentType.MD(s, 'mdocs'),
F: s => s, 
});
...
if (def.library) {
const libraryName = `${ def.Parent }-${ def.name }`.toLowerCase();
modulo.config.library.tagAliases[def.TagName] = libraryName;
def.TagName = libraryName;
}
def.MainRequire = def.DefinitionName;
const className =  def.TagName.replace('-', '_');
def.Code = `const def = modulo.definitions['${ def.DefinitionName }'];
class ${ className } extends window.HTMLElement {
constructor(){ super(); this.init(); }
static observedAttributes = [];
}
modulo.util.initComponentClass(modulo, def, ${ className });
...
modulo.registry.modules.configuration1 = function configuration1 (modulo) { 
...
window.customElements.define("x-wordart3d", x_wordart3d);
return x_wordart3d;}
...
window.customElements.define("x-downloads", x_downloads);
return x_downloads;}
...
window.customElements.define("x-abstractart3d", x_abstractart3d);
...
window.customElements.define("x-demo", x_demo);
return x_demo;}
...
window.customElements.define("x-pagecontrols", x_pagecontrols);
...
window.customElements.define("x-page", x_page);
return x_page;}
...
OUT.push(G.filters.escape(CTX.state.createModuloVersion));
OUT.push("/");
...
if (CTX.file.data) {
OUT.push("\n        <meta charset=\"utf8\">\n        <title>");
OUT.push(G.filters.escape(CTX.file.data.page_title));
OUT.push("</title>\n        ");
if (CTX.file.data.extra_style) {
OUT.push("\n            <style>");
OUT.push(G.filters.escape(CTX.file.data.extra_style));
OUT.push("</style>\n        ");
}
OUT.push("\n    ");
}
...
OUT.push("\" href=\"");
OUT.push(G.filters.escape(G.filters["default"](CTX.props.rootat,"")));
...
if (CTX.file.data) {
OUT.push(G.filters.escape(G.filters["default"](CTX.file.data.theme,"normal")));
}
OUT.push("\">\n        ");
OUT.push("\n        <h1>");
OUT.push(G.filters.escape(G.filters["default"](CTX.file.data.page_title,"")));
OUT.push("</h1>\n        <h4>");
OUT.push(G.filters.escape(G.filters["default"](CTX.file.data.page_author,"")));
OUT.push("</h4>\n\n        ");
OUT.push("\n        ");
if (CTX.file.data.body) {
OUT.push("\n        <div class=\"markdown-page\">\n            ");
OUT.push(G.filters.escape(G.filters["safe"](CTX.file.data.body)));
OUT.push("\n        </div>\n        ");
}
OUT.push("\n\n        ");
OUT.push("\n        ");
if (CTX.file.data.bottomlist === "articles") {
OUT.push("\n        ");
...
x: {"Type":"library","Parent":"modulo","DefName":null,"Contains":"core","DefLoaders":["DefTarget","DefinedAs","Src","Content|LoadDefs"],"Override":{"library":true},"tagAliases":{"html-table":"table","js":"script","x-wordart3d":"x-wordart3d","x-downloads":"x-downloads","x-abstractart3d":"x-abstractart3d","x-demo":"x-demo","x-pagecontrols":"x-pagecontrols","x-page":"x-page"},"name":"x","Name":"x","DefinitionName":"x","Source":"file:///home/michaelb/projects/modulo-site/static/components/","ChildrenNames":["x_WordArt3D","x_Downloads","x_AbstractArt3D","x_Demo","x_PageControls","x_Page"]},
...
configuration1: {"Type":"configuration","Parent":"modulo","DefName":null,"DefLoaders":["DefTarget","DefinedAs","Src|SrcSync","Content|Code","DefinitionName|MainRequire"],"Name":"configuration1"},

x_WordArt3D: {"Type":"component","Parent":"x","DefName":null,"mode":"regular","namespace":"x","rerender":"event","Contains":"part","RenderObj":"component","DefLoaders":["DefTarget","DefinedAs","Src","FilterContent","Content|LoadDefs"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"CommandBuilders":["Prebuild|BuildLifecycle","BuildLifecycle"],"Directives":["onMount","onUnmount"],"DirectivePrefix":"","name":"WordArt3D","Name":"WordArt3D","DefinitionName":"x_WordArt3D","Source":"file:///home/michaelb/projects/modulo-site/static/components/WordArt3D.html","ChildrenNames":["x_WordArt3D_props","x_WordArt3D_template","x_WordArt3D_state","x_WordArt3D_pagectls","x_WordArt3D_script","x_WordArt3D_style"],"library":true,"TagName":"x-wordart3d"},

x_Downloads: {"Type":"component","Parent":"x","DefName":null,"mode":"regular","namespace":"x","rerender":"event","Contains":"part","RenderObj":"component","DefLoaders":["DefTarget","DefinedAs","Src","FilterContent","Content|LoadDefs"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"CommandBuilders":["Prebuild|BuildLifecycle","BuildLifecycle"],"Directives":["onMount","onUnmount"],"DirectivePrefix":"","name":"Downloads","Name":"Downloads","DefinitionName":"x_Downloads","Source":"file:///home/michaelb/projects/modulo-site/static/components/Downloads.html","ChildrenNames":["x_Downloads_props","x_Downloads_template","x_Downloads_state","x_Downloads_staticdata"],"library":true,"TagName":"x-downloads"},

x_AbstractArt3D: {"Type":"component","Parent":"x","DefName":null,"mode":"regular","namespace":"x","rerender":"event","Contains":"part","RenderObj":"component","DefLoaders":["DefTarget","DefinedAs","Src","FilterContent","Content|LoadDefs"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"CommandBuilders":["Prebuild|BuildLifecycle","BuildLifecycle"],"Directives":["onMount","onUnmount"],"DirectivePrefix":"","name":"AbstractArt3D","Name":"AbstractArt3D","DefinitionName":"x_AbstractArt3D","Source":"file:///home/michaelb/projects/modulo-site/static/components/AbstractArt3D.html","ChildrenNames":["x_AbstractArt3D_props","x_AbstractArt3D_state","x_AbstractArt3D_template"],"library":true,"TagName":"x-abstractart3d"},

x_Demo: {"Type":"component","Parent":"x","DefName":null,"mode":"regular","namespace":"x","rerender":"event","Contains":"part","RenderObj":"component","DefLoaders":["DefTarget","DefinedAs","Src","FilterContent","Content|LoadDefs"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"CommandBuilders":["Prebuild|BuildLifecycle","BuildLifecycle"],"Directives":["onMount","onUnmount"],"DirectivePrefix":"","name":"Demo","Name":"Demo","DefinitionName":"x_Demo","Source":"file:///home/michaelb/projects/modulo-site/static/components/Demo.html","ChildrenNames":["x_Demo_props","x_Demo_state","x_Demo_template","x_Demo_demo_embed","x_Demo_demo_markdown","x_Demo_demo_component","x_Demo_demo_greetex","x_Demo_style"],"library":true,"TagName":"x-demo"},

x_PageControls: {"Type":"component","Parent":"x","DefName":null,"mode":"regular","namespace":"x","rerender":"event","Contains":"part","RenderObj":"component","DefLoaders":["DefTarget","DefinedAs","Src","FilterContent","Content|LoadDefs"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"CommandBuilders":["Prebuild|BuildLifecycle","BuildLifecycle"],"Directives":["onMount","onUnmount"],"DirectivePrefix":"","name":"PageControls","Name":"PageControls","DefinitionName":"x_PageControls","Source":"file:///home/michaelb/projects/modulo-site/static/components/PageControls.html","ChildrenNames":["x_PageControls_props","x_PageControls_template","x_PageControls_state","x_PageControls_script","x_PageControls_style"],"library":true,"TagName":"x-pagecontrols"},

x_Page: {"Type":"component","Parent":"x","DefName":null,"mode":"vanish","namespace":"x","rerender":"event","Contains":"part","RenderObj":"component","DefLoaders":["DefTarget","DefinedAs","Src","FilterContent","Content|LoadDefs"],"DefBuilders":["CustomElement","Code"],"DefFinalizers":["MainRequire"],"CommandBuilders":["Prebuild|BuildLifecycle","BuildLifecycle"],"Directives":["onMount","onUnmount"],"DirectivePrefix":"","name":"Page","Name":"Page","DefinitionName":"x_Page","Source":"file:///home/michaelb/projects/modulo-site/static/components/Page.html","ChildrenNames":["x_Page_props","x_Page_template","x_Page_style","x_Page_page_splash","x_Page_style1","x_Page_style2"],"library":true,"TagName":"x-page"},
...
x_WordArt3D_template: {"Type":"template","Parent":"x_WordArt3D","DefName":null,"DefFinalizers":["Content|CompileTemplate","Code"],"unsafe":"filters.escape","modeTokens":["{% %}","{{ }}","{# #}","{-{ }-}","{-% %-}"],"opTokens":"==,>,<,>=,<=,!=,not in,is not,is,in,not,gte,lte,gt,lt","opAliases":{"==":"X === Y","is":"X === Y","is not":"X !== Y","!=":"X !== Y","not":"!(Y)","gt":"X > Y","gte":"X >= Y","lt":"X < Y","lte":"X <= Y","in":"(Y).includes ? (Y).includes(X) : (X in Y)","not in":"!((Y).includes ? (Y).includes(X) : (X in Y))"},"Name":"template","DefinitionName":"x_WordArt3D_template"},
...
x_AbstractArt3D_template: {"Type":"template","Parent":"x_AbstractArt3D","DefName":null,"DefFinalizers":["Content|CompileTemplate","Code"],"unsafe":"filters.escape","modeTokens":["{% %}","{{ }}","{# #}","{-{ }-}","{-% %-}"],"opTokens":"==,>,<,>=,<=,!=,not in,is not,is,in,not,gte,lte,gt,lt","opAliases":{"==":"X === Y","is":"X === Y","is not":"X !== Y","!=":"X !== Y","not":"!(Y)","gt":"X > Y","gte":"X >= Y","lt":"X < Y","lte":"X <= Y","in":"(Y).includes ? (Y).includes(X) : (X in Y)","not in":"!((Y).includes ? (Y).includes(X) : (X in Y))"},"Name":"template","DefinitionName":"x_AbstractArt3D_template"},
...
x_Demo_template: {"Type":"template","Parent":"x_Demo","DefName":null,"DefFinalizers":["Content|CompileTemplate","Code"],"unsafe":"filters.escape","modeTokens":["{% %}","{{ }}","{# #}","{-{ }-}","{-% %-}"],"opTokens":"==,>,<,>=,<=,!=,not in,is not,is,in,not,gte,lte,gt,lt","opAliases":{"==":"X === Y","is":"X === Y","is not":"X !== Y","!=":"X !== Y","not":"!(Y)","gt":"X > Y","gte":"X >= Y","lt":"X < Y","lte":"X <= Y","in":"(Y).includes ? (Y).includes(X) : (X in Y)","not in":"!((Y).includes ? (Y).includes(X) : (X in Y))"},"Name":"template","DefinitionName":"x_Demo_template"},

x_Demo_demo_embed: {"Type":"template","Parent":"x_Demo","DefName":null,"DefFinalizers":["Content|CompileTemplate","Code"],"unsafe":"filters.escape","modeTokens":["{% %}","{{ }}","{# #}","{-{ }-}","{-% %-}"],"opTokens":"==,>,<,>=,<=,!=,not in,is not,is,in,not,gte,lte,gt,lt","opAliases":{"==":"X === Y","is":"X === Y","is not":"X !== Y","!=":"X !== Y","not":"!(Y)","gt":"X > Y","gte":"X >= Y","lt":"X < Y","lte":"X <= Y","in":"(Y).includes ? (Y).includes(X) : (X in Y)","not in":"!((Y).includes ? (Y).includes(X) : (X in Y))"},"Name":"demo_embed","DefinitionName":"x_Demo_demo_embed"},

x_Demo_demo_markdown: {"Type":"template","Parent":"x_Demo","DefName":null,"DefFinalizers":["Content|CompileTemplate","Code"],"unsafe":"filters.escape","modeTokens":["{% %}","{{ }}","{# #}","{-{ }-}","{-% %-}"],"opTokens":"==,>,<,>=,<=,!=,not in,is not,is,in,not,gte,lte,gt,lt","opAliases":{"==":"X === Y","is":"X === Y","is not":"X !== Y","!=":"X !== Y","not":"!(Y)","gt":"X > Y","gte":"X >= Y","lt":"X < Y","lte":"X <= Y","in":"(Y).includes ? (Y).includes(X) : (X in Y)","not in":"!((Y).includes ? (Y).includes(X) : (X in Y))"},"Name":"demo_markdown","DefinitionName":"x_Demo_demo_markdown"},

x_Demo_demo_component: {"Type":"template","Parent":"x_Demo","DefName":null,"DefFinalizers":["Content|CompileTemplate","Code"],"unsafe":"filters.escape","modeTokens":["{% %}","{{ }}","{# #}","{-{ }-}","{-% %-}"],"opTokens":"==,>,<,>=,<=,!=,not in,is not,is,in,not,gte,lte,gt,lt","opAliases":{"==":"X === Y","is":"X === Y","is not":"X !== Y","!=":"X !== Y","not":"!(Y)","gt":"X > Y","gte":"X >= Y","lt":"X < Y","lte":"X <= Y","in":"(Y).includes ? (Y).includes(X) : (X in Y)","not in":"!((Y).includes ? (Y).includes(X) : (X in Y))"},"Name":"demo_component","DefinitionName":"x_Demo_demo_component"},

x_Demo_demo_greetex: {"Type":"template","Parent":"x_Demo","DefName":null,"DefFinalizers":["Content|CompileTemplate","Code"],"unsafe":"filters.escape","modeTokens":["{% %}","{{ }}","{# #}","{-{ }-}","{-% %-}"],"opTokens":"==,>,<,>=,<=,!=,not in,is not,is,in,not,gte,lte,gt,lt","opAliases":{"==":"X === Y","is":"X === Y","is not":"X !== Y","!=":"X !== Y","not":"!(Y)","gt":"X > Y","gte":"X >= Y","lt":"X < Y","lte":"X <= Y","in":"(Y).includes ? (Y).includes(X) : (X in Y)","not in":"!((Y).includes ? (Y).includes(X) : (X in Y))"},"Name":"demo_greetex","DefinitionName":"x_Demo_demo_greetex"},
...
x_PageControls_template: {"Type":"template","Parent":"x_PageControls","DefName":null,"DefFinalizers":["Content|CompileTemplate","Code"],"unsafe":"filters.escape","modeTokens":["{% %}","{{ }}","{# #}","{-{ }-}","{-% %-}"],"opTokens":"==,>,<,>=,<=,!=,not in,is not,is,in,not,gte,lte,gt,lt","opAliases":{"==":"X === Y","is":"X === Y","is not":"X !== Y","!=":"X !== Y","not":"!(Y)","gt":"X > Y","gte":"X >= Y","lt":"X < Y","lte":"X <= Y","in":"(Y).includes ? (Y).includes(X) : (X in Y)","not in":"!((Y).includes ? (Y).includes(X) : (X in Y))"},"Name":"template","DefinitionName":"x_PageControls_template"},
...
x_Page_props: {"Type":"props","Parent":"x_Page","Content":"","DefName":null,"slotclass":"","rootat":"","Name":"props","DefinitionName":"x_Page_props"},

x_Page_template: {"Type":"template","Parent":"x_Page","DefName":null,"DefFinalizers":["Content|CompileTemplate","Code"],"unsafe":"filters.escape","modeTokens":["{% %}","{{ }}","{# #}","{-{ }-}","{-% %-}"],"opTokens":"==,>,<,>=,<=,!=,not in,is not,is,in,not,gte,lte,gt,lt","opAliases":{"==":"X === Y","is":"X === Y","is not":"X !== Y","!=":"X !== Y","not":"!(Y)","gt":"X > Y","gte":"X >= Y","lt":"X < Y","lte":"X <= Y","in":"(Y).includes ? (Y).includes(X) : (X in Y)","not in":"!((Y).includes ? (Y).includes(X) : (X in Y))"},"Name":"template","DefinitionName":"x_Page_template"},
...
modulo.registry.modules.configuration1.call(window, modulo);
